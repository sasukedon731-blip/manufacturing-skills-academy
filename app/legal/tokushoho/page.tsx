...
お問い合わせはメール（support@outin-plus.com）までお願いいたします。`}
        ...
        <SectionTitle>支払い時期</SectionTitle>
        <p style={styles.text}>お申し込み時に決済されます。</p>

        <SectionTitle>サービス提供時期</SectionTitle>
        <p style={styles.text}>
          クレジットカード決済の場合は決済完了後、直ちに利用可能です。
          コンビニ決済の場合は入金確認後に利用可能になります。
        </p>

        <SectionTitle>商品内容</SectionTitle>
        <p style={styles.text}>
          製造現場で使う日本語、JLPT学習、ゲーム形式の学習、AI会話・AIスピーキング等を提供するWebアプリです。
          基本学習プランでは日本語・製造系・ゲーム教材を利用できます。
          AI会話・AIスピーキングは別料金のAIオプションです。
        </p>
